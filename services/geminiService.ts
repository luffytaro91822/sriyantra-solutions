...
// In environments where process.env is not available, this would throw an error.
// We initialize lazily or assume the key is provided if the service is used.
...
export const generateInvoiceJson = async (
  ...
  if (!ai) {
    throw new Error("Gemini API key is not configured. Please set 'VITE_API_KEY' in your environment variables.");
  }
